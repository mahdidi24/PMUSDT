    ...
    <Container>
      ...
      >
        <Typography
          ...
          lineHeight="77px"
          sx={{
            background: "linear-gradient(to right, #1D8D94 0%, #91D2A3 10%)",
        ...
        <Stack
          direction="row"
          gap="20px"
          sx={{ marginTop: "39px", marginBottom: "30px" }}
        >
          <Box
            display="flex"
            alignItems="center"
          ...
          <Button sx={{ fontSize: "18px", padding: "19px 48px" }}>
            Search
          </Button>
        </Stack>
