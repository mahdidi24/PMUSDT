    ...
    return (
        <Container>
            <Stack direction="row" alignItems="center" gap="40px" sx={{backgroundColor:theme.palette.secondary.main, borderRadius:"30px", marginTop:"78px", padding:"0px 25px 0px 55px"}}>
                ...
                <Box sx={{backgroundColor:theme.palette.background.default, marginTop: "-50px" ,transform:" translateY(80px)" ,borderRadius:"100%" , padding:"67px"}}>
                    <img src="/aboutimg.png" alt="aboutus-img" />
                </Box>
            </Stack>
