...
} iconPosition='start' label="profile" sx={{justifyContent : "start" , fontSize : "16px" , color : theme.palette.text.primary , borderRadius : 5 ,  "&.Mui-selected":{color:"#fff", fontWeight:"bold"}}} />
...
} iconPosition='start' label="partner program" sx={{justifyContent : "start" , fontSize : "16px" , color : theme.palette.text.primary , borderRadius : 5 , "&.Mui-selected":{color:"#fff", fontWeight:"bold"}}} />
